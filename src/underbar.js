(function() {
  ...
  _.last = function(array, n) {
    if(array.length < n) {
      ...
      var sliceStart = array.length - n;
    }
    return n === undefined ? array[array.length - 1] : array.slice(sliceStart, array.length);
  };
  ...
  _.extend = function(obj) {
    if(arguments.length > 1) {
      for(var a = 1; a < arguments.length; a++) {
        _.each(arguments[a],function(value, key, argument) {
          obj[key] = value;
        })
      }
    }
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if(results[argObj] === undefined) {
        results[argObj] = func.apply(this,arguments);
      }
      return results[argObj];
    }
  };
